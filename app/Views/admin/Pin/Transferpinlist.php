...
<!--                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        ...
                        <a href="pintransfertouser" class="btn btn-primary waves-effect waves-light">
...
<?php if ($pagination['haveToPaginate']) { ?>
                                <br>
    <?php echo view('admin/_paging', array('paginate' => $pagination, 'siteurl' => 'listpintransfertouser', 'varExtra' => $searchArray)); ?>
