                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="row">
                            <div class="col-lg-3"> 
                               <h4 class="card-title">Update TDS</h4>     
                          </div>                        
                    </div>
                  <hr>
                 <form class="custom-validation"  method='post' action="<?php echo site_url('Admin/saveTDS'); ?>" >                              
                              ...
                              <div class="row">
                                <div class="col-md-10">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                     <input type="text" class="form-control" placeholder="Enter Amount" name="tds" required value="<?php echo (isset($edit) && !empty($edit)) ? $edit['tds'] : ''; ?>"/>
                                   </div>
                                  </div>
                               </div>                             
                           </div>
