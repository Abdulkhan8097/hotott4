                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="row">
                            <div class="col-lg-3"> 
                               <h4 class="card-title">Update Admin Charges</h4>     
                          </div>                        
                    </div>
                  <hr>
                 <form class="custom-validation"  method='post' action="<?php echo site_url('Admin/savepointShareCharges'); ?>" >                              
                              ...
                              <div class="row">
                                <div class="col-md-10">
                                  ...
                                  <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 ml-4 col-form-label">Remark</label>
                                    <div class="col-sm-6">
                                     <input type="text" class="form-control" placeholder="Enter Remark" name="remark" required value="<?php echo (isset($edit) && !empty($edit)) ? $edit['remark'] : ''; ?>"/>
                                   </div>
                                  </div>
                               </div>                             
                           </div>
