...
<!--                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        ...
                        <a href="AddCustomer" class="btn btn-primary waves-effect waves-light">
                            <i class="ion ion-md-add-circle-outline"></i> Add Join Member
                        </a>
...
<?php echo view('admin/_topmessage'); ?>
            ...
            <th   data-sortable="true">Sponsor Name</th>
        ...
        foreach ($tree as $key => $value) {
            ...
            if (isset($value['children'])) {
                foreach ($value['children'] as $child_key => $child_value) {
                    echo "<tr>";
                    // echo "<td>$child_key</td>";
                    echo "<td>{$child_value['name']}</td>";
                    echo "<td>{$child_value['username']}</td>";
                    echo "<td>{$child_value['side']}</td>";
                    echo "<td>{$child_value['sponsor_name']}</td>";
                    echo "<td>{$child_value['level']}</td>";
                    // echo "<td>{$child_value['path']}</td>";
                    echo "</tr>";
                }
            }
        }
