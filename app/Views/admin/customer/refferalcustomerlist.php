        ...
        <div class="row align-items-center">
            <div class="col-sm-4">
                <div class="page-title-box">
                    <h4 class="font-size-20">SOCIAL MEDIA TEAM</h4>
                </div>
            </div>
        ...
        <!-------------------------------- search --------------------------->
            ...
            <div class="col-xl-12">
             <form action="">
                <div class="row">                   
                    <div class="col-lg-5">
                        <input class="form-control" name="txtsearch" type="text" value="<?php echo $txtsearch; ?>" placeholder="Search User ID Mobile no. Email" >
                    </div>
                    ...
                    <div class="col-lg-1">
                       ...
                       <div class="col-lg-1">
                        <a href="referralfTeam" class="btn btn-primary waves-effect waves-light mr-1">
                            Reset
                        </a>
                    </div>
                   </form>
       ...
       <?php }
        ?>
                            ...
                            <?php if ($pagination['haveToPaginate']) { ?>
                                <br>
    <?php echo view('admin/_paging', array('paginate' => $pagination, 'siteurl' => 'referralfTeam', 'varExtra' => $searchArray)); ?>
