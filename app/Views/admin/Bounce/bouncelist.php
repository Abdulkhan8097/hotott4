        ...
        <div class="row align-items-center">
            <div class="col-sm-4">
                <div class="page-title-box">
                    <h4 class="font-size-20">Bonus Details</h4>
                </div>
            </div>
                           ...
                           <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" data-sortable="true">Bonus Type</th>
                                ...
                                <tbody>
                                    <tr>
                                        <?php 
                                        $i=0;
                                        foreach ($bounce as $kdata) {
                                            $i++;
                                            ?>
                                        <th class="text-center"><?php echo $i; ?></th>
                                        <td class="text-center"><?php echo $kdata['b_type']; ?></td>
                                        <td class="text-center"><?php echo $kdata['amount']; ?></td>
                                
                                        <td class="text-center"><?php echo $kdata['created_date']; ?></td>
                                         <td class="text-center"><?php echo $kdata['update_date']; ?></td>
...
<!-- 
						 ...
						 <a class="btn btn-primary waves-effect waves-light" href="<?php //echo site_url('CustomerDetails?id=' . $kdata->id); ?>">
                                            ...
                                            <td class="text-center">
                                                <a title="edit" class="btn btn-success waves-effect waves-light" href="<?php echo site_url('editbounce?id='.$kdata['id']); ?>">
