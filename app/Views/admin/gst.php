                           ...
                           <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" data-sortable="true">CGST</th>
                                        <th class="text-center" data-sortable="true">SGST</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $kdata['cgst']; ?></td>
                                        <td class="text-center"><?php echo $kdata['sgst']; ?></td>
                                        ...
                                        <td class="text-center"><?php echo $kdata['created_on']; ?></td>
                                         <td class="text-center"><?php echo $kdata['edited_on']; ?></td>
                                            ...
                                            <td class="text-center">
                                                <a title="edit" class="btn btn-success waves-effect waves-light" href="<?php echo site_url('editGST?id='.$kdata['id']); ?>">
