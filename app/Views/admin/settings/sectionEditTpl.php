            ...
            <div class="panel panel-default" style="margin-top:-30px">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-10 col-sm-10">
                        ...
                        <form action="<?php echo site_url("adminMenuList/updateSectionName?id=" . $menuDetailArray->id); ?>" method="post" name="addGroupForm" id="addGroupForm"  enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="70%" >
                                            <input type="text" name="txtName" id="txtName" class="form-control" value="<?php echo $menuDetailArray->setting_value; ?>" required>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <div class=" col-md-4">	<select id="txtStatus" name="txtStatus" class="form-control">
                                                    <option <?php if ($menuDetailArray->setting_status == 0) { ?> selected="selected" <?php } ?> value="0">Inactive</option>
                                                    <option <?php if ($menuDetailArray->setting_status == 1) { ?> selected="selected"<?php } ?> value="1">Active</option>
                                                </select>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2" align="center" >
                                            ...
                                            <a href="<?php echo site_url('adminMenuList/sectionList'); ?>" class="btn btn-primary">Back </a>
                                        </td>
                                    </tr>
