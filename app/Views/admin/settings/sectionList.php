<div class="row">
    <div class="col-sm-12" ><h3><img src="<?php echo base_url("assets/admin/images/group.png");?>" height="30" width="30">Section Management</h3></div>
  <div class="col-sm-12">
      <?php $this->load->view('admin/_topmessage'); ?>
  <div class="panel panel-default">
    <div class="panel-heading">
      <div>
        <form action="<?php echo site_url('adminMenuList/sectionList');?>" method="post" class="form-inline" name="search_list_form" id="search_list_form">
          ...
          <a href="<?php echo site_url('adminMenuList/sectionList');?>" class="btn btn-primary btn-sm" style="margin-right:10px">Refresh</a>
          ...
          <tbody>
            <?php if($pagination['getNbResults']){ $i=$startLimit;?>
              <?php foreach($menuData as $kData){ 
                ...
                <tr>
                  <td><?php echo ++$i;?></td>
                  <td><?php echo $kData->setting_value;?></td>
                  <td><?php if($kData->setting_status == 0) echo "Inactive"; else echo "Active";?></td>
                  
                  <td>                      
                    <a class="btn btn-info btn-sm" href="<?php echo site_url("adminMenuList/editSection?id=".$kData->id); ?>" title="Edit"><i class="fa fa-edit"></i></a>
                  </td>
                </tr>
              <?php } } else{ ?>
            <tr>
