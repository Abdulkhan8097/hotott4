                                         ...
                                         <td class="text-center">
                                           ...
                                           <?php } ?> 
                                            ...
                                            <td class="text-center">
                                                 ...
                                                 <a title="edit" class="btn btn-success waves-effect waves-light" href="<?php echo site_url('Award/awardclaim?id='.$kdata->a_id.'&userid='.$username); ?>">
                                                    <i class="fas fa-edit"></i> Claim
                                                </a> 
                                            </td>                                            
                                        </tr>
                            <?php } ?>
