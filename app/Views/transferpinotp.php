    ...
    <section id="main-site">
        <div class="glass text-center">
            ...
            <!-- <form method="post" action="<?php //echo site_url('Admin/logincheck');?>" class="py-2"> -->
                ...
                <div class="col py-1">
                    <input type="text"  name="nu1" maxlength="1" onKeyUp="numericFilter(this);" required class="form-control in1">
                    <input type="text"  name="nu2"  maxlength="1" onKeyUp="numericFilter(this);" required class="form-control in1">
                    <input type="text"  name="nu3" maxlength="1" onKeyUp="numericFilter(this);" required class="form-control in1">
                    <input type="text"  name="nu4"  maxlength="1" onKeyUp="numericFilter(this);" required class="form-control in1">
                </div>
                ...
                <div class="col">
                     ...
                     <input type="hidden" name="pin_type" value="<?php echo $pin_type;?>" class="form-control">
                     <input type="hidden" name="qty" value="<?php echo $qty;?>" class="form-control">
                     <input type="hidden" name="pass" value="<?php echo $pass;?>" class="form-control">
                     <input type="hidden" name="id" value="<?php echo $id;?>" class="form-control">
                     <input type="hidden" name="login_type" value="<?php echo (isset($admin) && !empty($admin)) ? $admin : ''; ?>" class="form-control">
...
$(document).ready(function() {
  $('#otp-form').submit(function(event) {
    ...
    var url = '<?php echo site_url("PinController/verifyOTP"); ?>';
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response == '<p class="error">Invalid OTP!</p>') {
          ...
          $(".formotp").attr('action', '<?php echo site_url("PinController/adminpinTranferSave");?>');
          $('#new').submit();
